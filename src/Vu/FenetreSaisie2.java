...
/**
 * <b>FenetreSaisie2 ouvre le PanelValeurs1</b>
 * <p>
...
public class FenetreSaisie2 extends JFrame {
     ...
     * @param parPanelGT
     */
	public FenetreSaisie2(String parTitre, DataGraph parDataGraph, File parFile, PanelGraphTab parPanelGT) 
	{
		super (parTitre);
		PanelValeurs1 Pane= new PanelValeurs1(parDataGraph, parFile,this, parPanelGT);
		setContentPane(Pane);
	...
	public static void main(String[] args, DataGraph data, File file, PanelGraphTab panelGT) {
		new FenetreSaisie2("Saisie",data,file,panelGT);
	}
